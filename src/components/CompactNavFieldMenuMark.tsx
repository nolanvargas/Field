import {
	FIELD_BRAND_GRADIENT_BOTTOM,
	FIELD_BRAND_GRADIENT_TOP,
} from '../../shared/fieldBrand.js';
		...
		>
			<defs>
				<linearGradient id={gradientId} x1='0' y1='0' x2='0' y2='1'>
					<stop offset='0' stopColor={FIELD_BRAND_GRADIENT_TOP} />
					<stop offset='1' stopColor={FIELD_BRAND_GRADIENT_BOTTOM} />
				</linearGradient>
			</defs>
